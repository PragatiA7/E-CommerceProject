...
import com.lcwd.electronic.storef.exceptions.BadApiRequestException;
import com.lcwd.electronic.storef.services.FileService;
...
public class FileServiceImpl implements FileService {
    ...
    public String uploadFile(MultipartFile file, String path) throws IOException {
        ...
        if(extention.equalsIgnoreCase(".png") || extention.equalsIgnoreCase(".jpg") || extention.equalsIgnoreCase(".jpeg")){
            ...
            logger.info("file extenstion is {} ",extention);
